  ...
  <div className={BookingPageStyles.bookingCardHeader}>
    ...
    <div className={BookingPageStyles.bookingExpandIcon}>
      ...
      <span className="ml-2 text-sm">
        {isExpanded ? "HideDetails" : "Show Details"}
      </span>
    </div>
  </div>
);
...
const BookingCardActions = ({
  ...
  <div className={BookingPageStyles.bookingActions}>
    <div className="items-center text-orange-400 hidden md:flex">
      ...
      />
      <span className="ml-2 text-sm">
        {isExpanded ? "Hide Actions" : "Show Details"}
      </span>
    </div>
...
const PageHeader = () => (
  <div className={BookingPageStyles.headerContainer}>
    ...
    <h1 className={BookingPageStyles.title}>
      <span className={BookingPageStyles.titleGradient}>
        {" "}
        Booking Dashboard{" "}
      </span>
    </h1>
...
const Booking = () => {
  ...
  //fetch the booking from server side
  ...
  //filtered bookings
  const filtererdBookings = useMemo(() => {
  ...
  const updateStatus = async (id) => {
    try {
      ...
      if (!newStatus) {
        window.alert("Please select a status before leaving");
        return;
      }
