...
//   fetch cars from server side and return it on UI
  ...
  //get from when till is is booked and when it will be available
  ...
  //we get disable on booking as it is booked already
