...
import { Users, Fuel, Gauge, CheckCircle } from 'lucide-react';
...
const HomeCars = () => {
    ...
    const visibleCars = carsData.slice(0,6); // Display only first 6 cars
  ...
  return (
    <div className = {styles.container}>
      ...
      <div className = {styles.headerContainer}>
        ...
        <p className={styles.subtitle}> Discover premium vehicles with exceptional performance and comfort for your next journey</p>
      </div>
