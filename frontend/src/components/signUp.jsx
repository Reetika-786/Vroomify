...
const signUp = () => {
  ...
  <div className={signupStyles.animatedBackground.base}>
    ...
    ></div>
      ...
      <FaArrowLeft className='text-xm sm:text-sm group-hover:-translate-x-1 transition:transform'/>
        <span className='font-medium text-xm sm:text-sm'> Back to Home </span>
      </a>
      ...
      <div
        ...
        <div className = {signupStyles.signupCard.headerContainer}>
            ...
            <h1 className={signupStyles.signupCard.title}> Join Premium Drive</h1>
            <p className={signupStyles.signupCard.subtitle}> Create your exclusive account
            </p>
        </div>
        ...
        >
            ...
            style = {{
                borderRadius : "16px",
                boxShadow : "0 2px 10px rgba(245, 124, 0, 0.06)",
            }}
            >
